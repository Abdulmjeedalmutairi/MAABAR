...
function ProductForm({
  ...
  return (
    <div style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border-muted)', padding: '28px 32px', maxWidth: 760, borderRadius: 'var(--radius-xl)' }}>
      ...
      <div style={{ marginBottom: 22, padding: '16px 18px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-subtle)', background: 'rgba(0,0,0,0.04)' }}>
      ...
      <div style={{ marginBottom: 22, padding: '16px 18px', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(0,0,0,0.10)', background: 'rgba(0,0,0,0.05)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, alignItems: 'center', flexWrap: 'wrap', marginBottom: 12 }}>
          <div>
            <p style={{ fontSize: 10, letterSpacing: 2, color: 'rgba(0,0,0,0.55)', textTransform: 'uppercase', marginBottom: 6 }}>
        ...
        <div style={{ height: 4, borderRadius: 999, background: 'rgba(0,0,0,0.05)', overflow: 'hidden', marginBottom: 14 }}>
          <div style={{ width: `${completenessPct}%`, height: '100%', borderRadius: 999, background: 'rgba(0,0,0,0.05)' }} />
        </div>
        <div style={{ display: 'grid', gap: 8 }}>
          {completenessItems.map((item) => (
            <div key={item.key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
              ...
              <span style={{ fontSize: 10, padding: '3px 9px', borderRadius: 999, border: '1px solid', borderColor: item.done ? 'rgba(58,122,82,0.25)' : 'var(--border-subtle)', background: item.done ? 'rgba(58,122,82,0.08)' : 'rgba(0,0,0,0.04)', color: item.done ? '#5a9a72' : 'var(--text-disabled)', whiteSpace: 'nowrap' }}>
  ...
  return (
    <div style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border-muted)', padding: '28px 32px', maxWidth: 760, borderRadius: 'var(--radius-xl)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 14, marginBottom: 20 }}>
        <div style={{ padding: '16px 18px', borderRadius: 'var(--radius-lg)', background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)' }}>
          <p style={{ fontSize: 10, letterSpacing: 2, textTransform: 'uppercase', color: 'rgba(0,0,0,0.55)', marginBottom: 10 }}>
...
function SaveFeedbackCard({ feedback, isAr = false }) {
  ...
  const tones = {
    ...
    neutral: { border: 'rgba(0,0,0,0.55)', background: 'rgba(0,0,0,0.05)', title: 'var(--text-primary)', body: 'var(--text-secondary)', meta: 'var(--text-disabled)' },
  };
  ...
  return (
    <div style={{ padding: '14px 16px', borderRadius: 'var(--radius-lg)', border: `1px solid ${palette.border}`, background: palette.background }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
        ...
        {feedback.meta && (
          <span style={{ alignSelf: 'flex-start', padding: '5px 10px', borderRadius: 999, border: '1px solid rgba(0,0,0,0.07)', background: 'rgba(0,0,0,0.04)', fontSize: 11, color: palette.meta, whiteSpace: 'nowrap' }}>
            {feedback.meta}
          </span>
        )}
      </div>
...
function SupplierJourneyStepper({ steps, isAr, lang }) {
  ...
  const stateStyles = {
    ...
    current: { border: '1px solid rgba(0,0,0,0.10)', background: 'rgba(0,0,0,0.05)', color: 'rgba(0,0,0,0.55)' },
    ...
    <div className="dashboard-wrap">
      ...
      <div className="dash-header-pad" style={{ background: 'var(--bg-subtle)', borderBottom: '1px solid var(--border-subtle)' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 20 }}>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 12px', borderRadius: 999, border: '1px solid var(--border-subtle)', background: 'rgba(0,0,0,0.03)', color: 'var(--text-secondary)', fontSize: 11 }}>
          ...
          {supplierMaabarId && supplierState.isApprovedStage && (
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '6px 12px', borderRadius: 999, border: '1px solid rgba(0,0,0,0.10)', background: 'rgba(0,0,0,0.05)', color: 'rgba(0,0,0,0.55)', fontSize: 11 }}>
              <span style={{ color: 'rgba(0,0,0,0.55)' }}>{t.supplierIdLabel}</span>
        ...
        <div className="dash-content">
          ...
          {activeTab === 'overview' && (
            <div style={section}>
              {isOnboardingLimited ? (
                <>
                  <div style={{ marginBottom: 24, padding: '24px 26px', background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', borderRadius: 'var(--radius-xl)' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, alignItems: 'flex-start', flexWrap: 'wrap' }}>
                      ...
                      <div style={{ minWidth: 220, maxWidth: 280, flex: '1 1 220px' }}>
                        ...
                        <div style={{ width: '100%', height: 8, borderRadius: 999, background: 'rgba(0,0,0,0.05)', overflow: 'hidden', marginBottom: 10 }}>
              ...
              {supplierState.isApprovedStage && (
                <div style={{ marginBottom: 32, padding: '24px 26px', background: '#FAF8F5', border: '1px solid rgba(80,180,120,0.22)', borderRadius: 'var(--radius-xl)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ minWidth: 220, maxWidth: 280, flex: '1 1 220px' }}>
                      <div style={{ padding: '16px 18px', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(0,0,0,0.07)', background: '#FFFFFF' }}>
              ...
              {needsVerification && (
                <div style={{ marginBottom: 32, padding: '20px 24px', background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', borderRadius: 'var(--radius-lg)' }}>
          ...
          {activeTab === 'verification' && (
            <div style={section}>
              ...
              <div style={{ marginBottom: 18, padding: '14px 16px', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(0,0,0,0.10)', background: 'rgba(0,0,0,0.05)', maxWidth: 920 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
          ...
          {activeTab === 'settings' && (
            <div style={section}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20, maxWidth: 760 }}>
                <div style={{ padding: '22px 24px', borderRadius: 'var(--radius-xl)', border: '1px solid rgba(0,0,0,0.10)', background: 'rgba(0,0,0,0.05)' }}>
                      ...
                      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                        {(settings.factory_images || []).map((img, i) => (
                          <div key={i} style={{ width: 90, height: 90, borderRadius: 'var(--radius-lg)', overflow: 'hidden', position: 'relative', flexShrink: 0, border: '1px solid var(--border-subtle)' }}>
                            ...
                            <button onClick={() => removeFactoryImage(img)} style={{ position: 'absolute', top: 4, right: 4, background: 'rgba(0,0,0,0.55)', color: 'rgba(0,0,0,0.88)', border: 'none', width: 18, height: 18, borderRadius: '50%', cursor: 'pointer', fontSize: 11, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>×</button>
                          </div>
                        ))}
