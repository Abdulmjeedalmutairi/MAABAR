...
// ─── MAABAR VERIFICATION FLOW — DESIGN SYSTEM ───────────────────────────────
// أضف هذا الكود مباشرة فوق سطر:
// /* ─── Main ───────────────────────────────── */
...
function VfChk({ size = 14, color = '#3D6B4F' }) {
  return (
...
function VfProgressBar({ step, status }) {
...
function VfStepBadges({ currentState, isAr, lang }) {
  const steps = [
