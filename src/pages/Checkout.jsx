        ...
        <div className="checkout-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, alignItems: 'start' }}>
          ...
          <div>
            ...
            {!isSecondPayment && selectedPct < 100 && (
              <div style={{ background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', borderRadius: 'var(--radius-lg)', padding: '14px 16px', marginBottom: 18 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  ...
                  <span style={{ fontSize: 15, fontWeight: 500, color: 'rgba(0,0,0,0.55)' }}>{fmt(firstPayment)} {currencyLabel}</span>
                </div>
            ...
            <div style={{ background: 'var(--bg-subtle)', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-lg)', padding: '16px', marginBottom: 16 }}>
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 12 }}>
                ...
                <span style={trustBadgeStyle('rgba(0,0,0,0.55)', 'rgba(0,0,0,0.55)', 'rgba(0,0,0,0.55)')}>
                  {t.leadTime}: {leadTimeLabel}
                </span>
                <span style={trustBadgeStyle('var(--text-secondary)', 'rgba(0,0,0,0.04)', 'var(--border-subtle)')}>
            ...
            <div style={{ background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', borderRadius: 'var(--radius-lg)', padding: '16px' }}>
              <p style={{ fontSize: 10, letterSpacing: 3, textTransform: 'uppercase', color: 'rgba(0,0,0,0.55)', marginBottom: 10, fontFamily: 'var(--font-sans)' }}>
                {t.protectionTitle}
              </p>
                  ...
                  {paymentOptions.map(opt => (
                    <button key={opt.pct} onClick={() => setSelectedPct(opt.pct)} disabled={!paymentGatewayReady} style={{
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                        ...
                        <span style={{ fontSize: 14, fontWeight: 500, color: 'rgba(0,0,0,0.55)' }}>
