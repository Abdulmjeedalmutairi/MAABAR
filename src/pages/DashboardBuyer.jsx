            ...
            <div style={section}>
              ...
              {!loadingRequests && myRequests.map((r, idx) => {
                ...
                <div key={r.id} data-request-id={r.id} style={{
                  ...
                  scrollMarginTop: 110,
                  background: isFocusedRequest ? 'rgba(0,0,0,0.55)' : 'transparent',
                  ...
                  {nextStepCopy && (
                    <div style={{ marginBottom: 14, padding: '12px 14px', borderRadius: 'var(--radius-lg)', border: '1px solid rgba(0,0,0,0.10)', background: 'rgba(0,0,0,0.05)' }}>
                      <p style={{ fontSize: 11, color: 'rgba(0,0,0,0.55)', marginBottom: 6, fontWeight: 500, fontFamily: isAr ? 'var(--font-ar)' : 'var(--font-sans)' }}>
                        {nextStepCopy.title}
                      </p>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 14 }}>
                    ...
                    <span style={{ fontSize: 11, padding: '5px 10px', borderRadius: 999, background: managed ? 'rgba(0,0,0,0.55)' : 'var(--bg-subtle)', border: `1px solid ${managed ? 'rgba(0,0,0,0.55)' : 'var(--border-subtle)'}`, color: managed ? 'rgba(0,0,0,0.55)' : 'var(--text-secondary)' }}>
                      {managed ? (isAr ? 'طلب مُدار' : 'Managed request') : `${isAr ? 'العروض' : 'Offers'}: ${r.offers.length}`}
                    </span>
                    {managed && (
                      <span style={{ fontSize: 11, padding: '5px 10px', borderRadius: 999, background: 'rgba(0,0,0,0.04)', border: '1px solid var(--border-subtle)', color: 'var(--text-secondary)' }}>
                    ...
                    {!managed && fastestOffer?.delivery_days && (
                      <span style={{ fontSize: 11, padding: '5px 10px', borderRadius: 999, background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', color: 'rgba(0,0,0,0.55)' }}>
                            ...
                            {(() => {
                              ...
                              return (
                                <>
                                  ...
                                  {supplierTrustSignals.length > 0 && (
                                    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 12 }}>
                                      ...
                                      {supplierTrustSignals.includes('wechat_available') && (
                                        <span style={{ fontSize: 9, padding: '2px 8px', borderRadius: 20, background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', color: 'rgba(0,0,0,0.55)' }}>
                                          WeChat
                                        </span>
                                      )}
                                      {supplierTrustSignals.includes('factory_media_available') && (
                                        <span style={{ fontSize: 9, padding: '2px 8px', borderRadius: 20, background: 'rgba(0,0,0,0.04)', border: '1px solid var(--border-subtle)', color: 'var(--text-secondary)' }}>
                                  ...
                                  {o.note && (
                                    <div style={{ marginBottom: 14, padding: '10px 12px', borderRadius: 'var(--radius-md)', background: 'rgba(0,0,0,0.04)', border: '1px solid var(--border-subtle)' }}>
                            ...
                            {o.status === 'accepted' && (
                              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                ...
                                {r.status === 'ready_to_ship' && (
                                  <div style={{ padding: '12px 12px', background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', borderRadius: 'var(--radius-md)' }}>
                ...
                return (
                  <div key={s.id} style={{ borderTop: '1px solid var(--border-subtle)', padding: '18px 0', animation: `fadeIn 0.35s ease ${idx * 0.04}s both` }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap', marginBottom: 10 }}>
                      ...
                      <span style={{ fontSize: 11, padding: '5px 10px', borderRadius: 999, background: s.status === 'approved' ? 'rgba(58,122,82,0.1)' : s.status === 'rejected' ? 'rgba(160,112,112,0.1)' : 'rgba(0,0,0,0.55)', color: s.status === 'approved' ? '#5a9a72' : s.status === 'rejected' ? '#a07070' : 'rgba(0,0,0,0.55)' }}>
                    ...
                    {(supplierTrustSignals.length > 0 || s.profiles?.rating > 0) && (
                      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 12 }}>
                        {s.profiles?.rating > 0 && (
                          <span style={{ fontSize: 10, padding: '3px 9px', borderRadius: 999, background: 'rgba(0,0,0,0.04)', border: '1px solid var(--border-subtle)', color: 'var(--text-secondary)' }}>
                        ...
                        {supplierTrustSignals.includes('wechat_available') && (
                          <span style={{ fontSize: 10, padding: '3px 9px', borderRadius: 999, background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', color: 'rgba(0,0,0,0.55)' }}>
                            WeChat
                          </span>
                        )}
                        {supplierTrustSignals.includes('factory_media_available') && (
