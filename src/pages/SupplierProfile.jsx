      ...
      <div className="profile-hero">
        ...
        <div>
          ...
          {supplierMaabarId && isReviewedSupplier && (
            <div style={{ marginTop: 8, display: 'inline-flex', alignItems: 'center', gap: 8, padding: '5px 10px', borderRadius: 999, border: '1px solid rgba(0,0,0,0.07)', background: 'rgba(0,0,0,0.04)', color: 'var(--text-secondary)', fontSize: 11, letterSpacing: 0.4 }}>
          ...
          <div style={{ display: 'flex', gap: 16, marginTop: 10, flexWrap: 'wrap' }}>
            ...
            {products.filter(p => p.sample_available).length > 0 && (
              <span style={{ fontSize: 11, color: 'rgba(0,0,0,0.55)', background: 'rgba(0,0,0,0.05)', padding: '2px 10px', borderRadius: 20, border: '1px solid rgba(0,0,0,0.10)' }}>
      ...
      <div className="profile-body">
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 40, flexWrap: 'wrap' }}>
          ...
          {products.some(p => p.sample_available) && (
            <button className="btn-outline" style={{ borderColor: 'rgba(0,0,0,0.10)', color: 'rgba(0,0,0,0.55)' }}
                  ...
                  <div key={s.id} onClick={() => nav(`/supplier/${s.id}`)} style={{
                    ...
                    <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 10 }}>
                      ...
                      {trustSignals.includes('wechat_available') && (
                        <span style={{ fontSize: 9, padding: '2px 8px', borderRadius: 999, background: 'rgba(0,0,0,0.05)', border: '1px solid rgba(0,0,0,0.10)', color: 'rgba(0,0,0,0.55)' }}>
                          WeChat
                        </span>
                      )}
                      {trustSignals.includes('factory_media_available') && (
                        <span style={{ fontSize: 9, padding: '2px 8px', borderRadius: 999, background: 'rgba(0,0,0,0.04)', border: '1px solid var(--border-subtle)', color: 'var(--text-secondary)' }}>
