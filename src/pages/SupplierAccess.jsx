...
const T = {
  en: {
    ...
    heroBody: 'Maabar is a Saudi B2B platform connecting Chinese suppliers with Saudi buyers. This page explains the supplier journey clearly: apply once, confirm the email, enter the supplier dashboard to complete verification, and unlock full access after approval.',
    ...
    flowBody: 'No second application and no hidden extra signup page. Complete the basic supplier application once, confirm the email, then your account opens the supplier dashboard so you can complete verification there. If your account is already approved, you should sign in instead of applying again.',
    steps: [
      ...
      { step: '03', title: 'Enter the dashboard and complete verification', description: 'After confirmation, the supplier lands in the supplier dashboard and can continue the verification flow from there.' },
    ...
    finalBody: 'New supplier applications enter the supplier dashboard after real email confirmation so verification can be completed there. Approved suppliers should return here to sign in directly and open the full supplier dashboard.',
    deadlineLabel: 'Time left in current intake',
    days: 'Days',
    hours: 'Hours',
    minutes: 'Minutes',
    finalChecklist: ['Shared signup only', 'No payout setup at first signup', 'Dashboard access after email confirmation'],
    applyNow: 'Apply now',
  ...
  zh: {
    ...
    heroBody: 'Maabar 是一家沙特 B2B 平台，连接中国供应商与沙特买家。这个页面会把供应商路径讲清楚：只申请一次、完成邮箱确认、进入供应商控制台继续认证，审核通过后解锁完整权限。',
    ...
    flowBody: '不会有第二套注册，也不会让您重复填表。基础供应商申请只提交一次，确认邮箱后，系统会打开供应商控制台，让您从那里继续完成认证。如果您的账户已经获批，就应直接登录，而不是重新申请。',
    steps: [
      ...
      { step: '03', title: '进入控制台并完成认证', description: '确认后会直接进入供应商控制台，并从那里继续认证流程。' },
    ...
    finalBody: '新申请在完成邮箱真实确认后，会先进入供应商控制台继续完成认证。已经批准的供应商应从这里直接登录并打开完整的供应商后台。',
    deadlineLabel: '当前入驻窗口剩余时间',
    days: '天',
    hours: '小时',
    minutes: '分钟',
    finalChecklist: ['统一申请页，只填一次', '首次申请不需要收款设置', '邮箱确认后进入供应商控制台'],
    applyNow: '立即申请',
  ...
  ar: {
    ...
    heroBody: 'مَعبر منصة سعودية B2B تربط الموردين الصينيين بالمشترين السعوديين. هذه الصفحة تشرح الرحلة بوضوح: تقديم واحد فقط، ثم تأكيد البريد، ثم الدخول إلى لوحة المورد لإكمال التحقق، وبعد الموافقة ينفتح الوصول الكامل.',
    ...
    flowBody: 'لا يوجد تسجيل ثانٍ ولا نماذج مكررة. ترسل طلب المورد الأساسي مرة واحدة، تؤكد البريد الإلكتروني، ثم تفتح لك لوحة المورد لتكمل التحقق من داخلها. وإذا كان حسابك معتمداً بالفعل فيفترض أن تسجّل الدخول مباشرة بدلاً من إعادة التقديم.',
    steps: [
      ...
      { step: '03', title: 'ادخل إلى لوحة المورد وأكمل التحقق', description: 'بعد التأكيد، يدخل المورد مباشرة إلى لوحة المورد ويكمل مسار التحقق من هناك.' },
    ...
    finalBody: 'طلبات الموردين الجديدة تدخل أولاً إلى لوحة المورد بعد تأكيد البريد فعلياً حتى يكتمل التحقق من هناك. أما الموردون الموافق عليهم فيفترض أن يعودوا من هنا إلى تسجيل الدخول المباشر وفتح لوحة المورد الكاملة.',
    deadlineLabel: 'الوقت المتبقي في نافذة القبول الحالية',
    days: 'أيام',
    hours: 'ساعات',
    minutes: 'دقائق',
    finalChecklist: ['تسجيل موحّد مرة واحدة', 'لا توجد بيانات payout في التسجيل الأول', 'الدخول للوحة المورد بعد تأكيد البريد'],
    applyNow: 'قدّم الآن',
