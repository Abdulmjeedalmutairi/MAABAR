    ...
    <div className="supplier-landing">
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px 12px' }}>
        <div style={{
          ...
          <div style={{ borderRadius: 24, border: '1px solid rgba(0,0,0,0.07)', background: 'var(--bg-raised)', padding: '22px 22px 20px' }}>
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              {t.trustItems.map((item) => (
                <div key={item} style={{ display: 'flex', gap: 10, alignItems: 'flex-start', color: 'rgba(0,0,0,0.72)' }}>
                  <span style={{ width: 7, height: 7, borderRadius: '50%', background: 'rgba(0,0,0,0.30)', marginTop: 7, flex: '0 0 auto' }} />
          ...
          <div style={{ borderRadius: 24, border: '1px solid rgba(0,0,0,0.07)', background: 'var(--bg-raised)', padding: '22px' }}>
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              {[
                ...
                isAr ? '3) دخول مباشر إلى لوحة المورد لإكمال التحقق' : lang === 'zh' ? '3) 直接进入供应商控制台继续认证' : '3) Land directly in the supplier dashboard to continue verification',
                ...
                <div key={item} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                  <span style={{ minWidth: 26, height: 26, borderRadius: 999, border: '1px solid rgba(0,0,0,0.12)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(0,0,0,0.88)', fontSize: 11 }}>{index + 1}</span>
                  <span style={{ fontSize: 13, lineHeight: 1.8, color: 'rgba(0,0,0,0.72)', fontFamily: isAr ? 'var(--font-ar)' : 'var(--font-sans)' }}>{item}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="sl-features">
        <p className="section-label" style={{ color: 'rgba(0,0,0,0.45)' }}>
