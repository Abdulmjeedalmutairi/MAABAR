...
const T = {
  ar: {
    ...
    steps: [
      ...
      { t: 'ادفع بأمان واستلم', d: 'أموالك محجوزة في معبر ولا تُحوَّل للمورد إلا بعد تأكيدك استلام البضاعة.' },
    ],
    ...
    trusts: [
      ...
      { num: '02', t: 'أمان مالي كامل', d: 'أموالك لا تتحرك حتى تصل بضاعتك — ضمان كامل في كل صفقة.' },
  ...
  en: {
    ...
    steps: [
      ...
      { t: 'Pay Safely and Receive', d: 'Your funds are held by Maabar and only released to the supplier after you confirm receipt.' },
    ],
    ...
    trusts: [
      ...
      { num: '02', t: 'Full Financial Security', d: "Your funds don't move until your order arrives — complete protection on every deal." },
  ...
  zh: {
    ...
    sub: '发布您的需求，认证中国供应商竞相报价，您的资金安全托管直至收货确认。',
    cta: '创造您自己的产品',
    reqCta: '发布需求',
