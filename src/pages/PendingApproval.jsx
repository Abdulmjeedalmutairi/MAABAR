  ...
  return (
    <div style={{
      ...
      <span style={{
        ...
        background: isPositive ? 'rgba(58,122,82,0.08)' : 'var(--bg-subtle)',
        borderRadius: 999,
        padding: '4px 10px',
        whiteSpace: 'nowrap',
      }}>
    ...
    <div style={{ minHeight: 'var(--app-dvh)', background: 'var(--bg-base)', color: 'var(--text-primary)' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto', padding: '92px 24px 48px' }}>
        <div style={{
          ...
          <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(circle at top right, rgba(0,0,0,0.03), transparent 28%)', pointerEvents: 'none' }} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.14fr 0.86fr', gap: 20 }} className="pending-review-grid">
          ...
          <div style={{
            ...
            <div style={{ padding: '16px 18px', borderRadius: 20, border: '1px solid var(--border-subtle)', background: 'var(--bg-subtle)' }}>
