...
const STATUS_MAP = {
  ...
  approved:                   { en: 'Verified',       ar: 'موثّق',          c: '#27725a', bg: 'rgba(39,114,90,0.08)',  b: 'rgba(39,114,90,0.18)' },
  ...
  submitted:                  { en: 'Under Review',  ar: 'قيد المراجعة',  c: '#8B6914', bg: 'rgba(139,105,20,0.08)', b: 'rgba(139,105,20,0.18)' },
  review:                     { en: 'Under Review',  ar: 'قيد المراجعة',  c: '#8B6914', bg: 'rgba(139,105,20,0.08)', b: 'rgba(139,105,20,0.18)' },
  verification_required:      { en: 'Needs Info',    ar: 'مطلوب استكمال', c: '#8B6914', bg: 'rgba(139,105,20,0.08)', b: 'rgba(139,105,20,0.18)' },
  ...
  disabled:                   { en: 'Inactive',      ar: 'غير نشط',        c: '#c0392b', bg: 'rgba(192,57,43,0.08)',  b: 'rgba(192,57,43,0.18)' },
  suspended:                  { en: 'Suspended',     ar: 'موقوف',          c: '#c0392b', bg: 'rgba(192,57,43,0.08)',  b: 'rgba(192,57,43,0.18)' },
  ...
  registered:                 { en: 'Registered',    ar: 'مسجّل',          c: 'rgba(0,0,0,0.55)', bg: 'rgba(0,0,0,0.04)', b: 'rgba(0,0,0,0.09)' },
  draft:                      { en: 'Registered',    ar: 'مسجّل',          c: 'rgba(0,0,0,0.45)', bg: 'rgba(0,0,0,0.04)', b: 'rgba(0,0,0,0.08)' },
  incomplete:                 { en: 'Registered',    ar: 'مسجّل',          c: 'rgba(0,0,0,0.45)', bg: 'rgba(0,0,0,0.04)', b: 'rgba(0,0,0,0.08)' },
